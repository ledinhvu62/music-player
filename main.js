...
const app = {
    ...
    songs: [
        ...
        {
            name: 'Co Mot Noi Nhu The',
            singer: 'Phan Manh Quynh',
            path: './assets/song/co_mot_noi_nhu_the.mp3',
            image: './assets/img/co_mot_noi_nhu_the.jpg',
        },
        {
            name: 'Lan Man',
            singer: 'Ronboogz',
    ...
    handleEvents() {
        ...
        audio.ontimeupdate = () => {
            if (audio.duration) {
                ...
                progress.style.background = `linear-gradient(90deg, var(--primary-color) ${progressPercent}%, #ddd ${progressPercent}%)` // đổi màu time range cho phần song đã nghe
        ...
        playlist.onclick = (e) => {
            ...
            if (e.target.closest('.option')) { // Xử lý khi click vào song option
            }
